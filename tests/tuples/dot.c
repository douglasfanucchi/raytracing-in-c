...
MU_TEST(test_dot_product_should_return_1_when_same_vectors_when_unit_vectors) {
...
MU_TEST_SUITE(test_dot_product) {
    ...
    MU_RUN_TEST(test_dot_product_should_return_1_when_same_vectors_when_unit_vectors);
}
